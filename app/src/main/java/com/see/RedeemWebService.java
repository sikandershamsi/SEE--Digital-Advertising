...
public class RedeemWebService extends AsyncTask<String, String, String> {
    ...
    public RedeemWebService(Context context,CategoriesRequestListener listener,String amount )
    {
    ...
    protected String doInBackground(String... aurl) {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(Api.API_URL+Api.request_withdraw);
           ...
           // nameValuePairs.add(new BasicNameValuePair("method", ""));
            //nameValuePairs.add(new BasicNameValuePair("account_no",""));
