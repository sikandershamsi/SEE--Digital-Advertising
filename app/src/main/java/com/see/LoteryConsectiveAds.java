...
public class LoteryConsectiveAds extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lotery_consective_ads);
        ...
        requestListener = new CategoriesRequestListener() {
            ...
            public void onSuccess(String result) {
                ...
                Toast.makeText(LoteryConsectiveAds.this,result,Toast.LENGTH_LONG).show();

                if (adscount == currentad) {
                    Toast.makeText(LoteryConsectiveAds.this, "Ads Completed", Toast.LENGTH_LONG).show();
                } else {
                    iscomplete = false;
                    adscount--;
                    currentad++;
              title = maplist.get(currentad).get("title").toString();
                    ...
                    simpleExoPlayer = ExoPlayerFactory.newSimpleInstance(LoteryConsectiveAds.this, trankSelector, loadControl);
...
//if(!running)break;
                             ...
                             // Toast.makeText(LoteryConsectiveAds.this,"Hammad",Toast.LENGTH_LONG).show();
                               new AddToLotteryWebService(LoteryConsectiveAds.this, requestListener).execute();
...
//if(!running)break;
                              ...
                              //Toast.makeText(LoteryConsectiveAds.this,"Hammad",Toast.LENGTH_LONG).show();
                                //new AddToLotteryWebService(LoteryConsectiveAds.this, requestListener).execute();
                               // new GetConsecutiveAds(LoteryConsectiveAds.this, crequestListener, "", latitude, longitude).execute();
                               new AddToWalletWebService(LoteryConsectiveAds.this, requestListener, id, HomeFragment.latitude, HomeFragment.longitude).execute();
                            } else if (playbackState == Player.STATE_IDLE) {
                                // Toast.makeText(PlayConsecutiveAds.this,"IDLE",Toast.LENGTH_LONG).show();
                                //Log.e("", "IDLE");
      ...
      /*** title=i.getStringExtra("title");
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                finish();
                Intent in = new Intent(LoteryConsectiveAds.this, Login.class);
                startActivity(in);
       ...
       /* btnFullscreen.setOnClickListener(new View.OnClickListener() {
        ...
        rate_ad.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Dialog rankDialog = new Dialog(LoteryConsectiveAds.this, R.style.FullHeightDialog);
                ...
                updateButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        rankDialog.dismiss();
                        new RateWebService(LoteryConsectiveAds.this, requestListener,id,String.valueOf(ratingBar.getRating()),etcomments.getText().toString()).execute();
    ...
    public void onBackPressed() {
        ...
        finish();
        Intent in=new Intent(LoteryConsectiveAds.this,Dashboard.class);
        startActivity(in);
        //exoplayer.release();
    }
