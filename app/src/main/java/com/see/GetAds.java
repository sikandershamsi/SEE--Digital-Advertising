...
public class GetAds extends AsyncTask<String, String, String> {
    ...
    public GetAds(Context context,CategoriesRequestListener listener,String categoryid,String latitude,String longitude)
    {
    ...
    protected String doInBackground(String... aurl) {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(Api.API_URL+Api.ads);
