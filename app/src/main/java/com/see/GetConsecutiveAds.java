...
public class GetConsecutiveAds extends AsyncTask<String, String, String> {
    ...
    public GetConsecutiveAds(Context context,CategoriesRequestListener listener,String categoryid,String latitude,String longitude)
    {
    ...
    protected String doInBackground(String... aurl) {
        ...
        try {
            ...
            HttpPost httppost = new HttpPost(Api.API_URL+Api.consective_ads);
