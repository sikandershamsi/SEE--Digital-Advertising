...
public class GetCategories extends AsyncTask<String, String, String> {
    ...
    public GetCategories(Context context,CategoriesRequestListener listener)
    {
        this.context = context;
        _listener = listener;
        mProgressDialog = new ProgressDialog(context,   R.style.AppTheme_Dark_Dialog);
        mProgressDialog.setIndeterminate(true);
        mProgressDialog.setMessage(context.getResources().getString(R.string.loadingcata));
    ...
    protected String doInBackground(String... aurl) {
        ...
        try {
            ...
            HttpGet httppost = new HttpGet(Api.API_URL+Api.categories);
